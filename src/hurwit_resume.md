...
title: Daniel Hurwit
---
Whately, MA | dhurwit@gmail.com | 617-721-2365 | [github.com/danhurwit](https://github.com/danhurwit) | [linkedin.com/in/danielhurwit](https://linkedin.com/in/danielhurwit)
...
**Covax Bot** — Built a COVID vaccine scraper bot to check for and publish availability from a variety of appointment sources. Bot was used by 50+ friends and family members to book appointments.

**Volthub** — Architected and built infrastructure, application for an MIT startup streamlining electrical component sourcing.

## Skills

**Languages:** Golang, Java 8+, Python, TypeScript, JavaScript, Elixir, Terraform\
**AWS & GCP:** RDS, SQS, SNS, Kinesis, DynamoDB, Lambda, Aurora, S3\
**Databases:** PostgreSQL, MySQL, NoSQL, Elasticsearch, SQLite, Spanner\
**Tools & Frameworks:** Docker, Maven, Flask, Kubernetes, React, OTel, Grafana, Git

## Education

**BSc. Mechanical Engineering** — Northeastern University, Class of 2016

**Relevant Coursework:** Object Oriented Design, Computer Systems, Algorithms, Discrete Math, Data Structures
